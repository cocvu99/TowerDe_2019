...
import static TowerDefense.GamePlay.GameFrame.pause;
...
public class Player  extends JPanel implements Runnable {
    ...
    private void createMonster(char c) {
        ...
        switch (c) {
            case '1': monsters.add(new normalMonster(MapManager.spawner.getPos())); break;
            case '2': monsters.add(new smallMonster(MapManager.spawner.getPos())); break;
            case '3': monsters.add(new tankerMonster(MapManager.spawner.getPos())); break;
            case '4': monsters.add(new bossMonster(MapManager.spawner.getPos())); break;
            case ' ': break;
        }
    }
